...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F9FB] text-[#113F67] flex font-sans">
      {/* Sidebar */}
      <aside
        className={`bg-[#113F67] border-r border-[#87C0CD]/30 text-white flex flex-col justify-between shrink-0 shadow-lg transition-all duration-300 ease-in-out ${
          collapsed ? 'w-20' : 'w-64'
        }`}
      >
        <div>
          {/* Brand Header & Toggle */}
          <div className={`p-4 border-b border-[#87C0CD]/20 flex items-center ${collapsed ? 'justify-center flex-col space-y-3' : 'justify-between'}`}>
            {!collapsed ? (
            ...
            <button
              ...
              className="p-1.5 rounded-lg bg-[#226597]/40 hover:bg-[#226597] text-slate-200 hover:text-white transition shadow-xs cursor-pointer shrink-0"
        ...
        <div className="p-3 border-t border-[#87C0CD]/20 space-y-3">
          {!collapsed ? (
            <>
            ...
            <div className="flex flex-col items-center space-y-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#226597]/50 hover:bg-[#226597] text-white rounded-xl transition flex items-center justify-center shadow-xs"
              ...
              <button
                onClick={handleLogout}
                className="w-10 h-10 text-rose-300 hover:text-rose-100 hover:bg-rose-900/50 rounded-xl transition flex items-center justify-center"
                title="Logout"
              >
                <LogOut className="w-4 h-4" />
              </button>
